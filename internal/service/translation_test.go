...
func translation(t *testing.T) (*service.TranslationService, *MockTranslationRepo, *MockTranslationWebAPI) {
	t.Helper()
	...
	translation := service.NewTranslationService(repo, webAPI)
